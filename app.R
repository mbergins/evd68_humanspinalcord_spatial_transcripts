...
ui <- fluidPage(
	...
	tags$ul(
		...
		tags$li("Vogt MR, et al. ", a(href="https://dx.doi.org/10.1056/NEJMc2118155","Enterovirus D68 in the Anterior Horn Cells of a Child with Acute Flaccid Myelitis
"),". N Engl J Med 2022; 386:2059-2060")
	),
	
	tags$p("Data generated by Vogt Laboratory. For inquiries, updated contact information maintained at ", a(href="https://www.vogtviruslab.com/","VogtVirusLab.com")),
